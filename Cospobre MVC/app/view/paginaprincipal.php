...
<html lang="en">
  ...
  <body>
    ...
    <img src="<?= BASEPATH ?>public/images/landing-page.svg" alt="otakus" width="100%" heigth="100px"/>
    <main>
      <section class="sections">
        ...
        <a href="<?= BASEPATH ?>conjuntos" style = "text-decoration: none;" >
          <div class="section">
            <button class="button" >Conjuntos</button>
          </div>
        </a>
        <a href="<?= BASEPATH ?>sapatos" style = "text-decoration: none;" >
          <div class="section">
