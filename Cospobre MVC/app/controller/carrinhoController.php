...
class carrinhoController extends Controller  {
    ...
    /**
    * 
    * @var Usuario O usuário que será chamado 
    */
    private $loggedUser;
    /**
    * 
    ...
    */
    ...
    /**
    *  Este método cria na sessão
    * o carrinho e verificar se está logado.
    */
...
/**vai para o carrinho, mesmo que não tenho produtos ainda se você estiver logado */
...
/**adiciona um produto ao carrinho e exibe o carrinho */
    ...
    {   if (!$this->loggedUser) {
        ...
        $produtosAdd = $_SESSION['carrinho']->produtosEscolhidos;
        if($produto){
            $this->view('carrinho/carrinho',$produtosAdd);
        }   
