...
<html lang="en">
  ...
  <body>
    ...
    <div class="conteudo">
      ...
      <div class="linha">
        <form action="<?= BASEPATH ?>pay/credit/success">
          <div class="linha">
            <div class="label">
              <label for="numCartao"><h3>Número do Cartão</h3></label>
            </div>
            <div class="input">
              <input type="text" id="numero" data-mask="0000 0000 0000 0000" placeholder="xxxx.xxxx.xxxx.xxxx" required/>
            </div>
          </div>
          ...
          <div class="linha">
            ...
            <div class="input">
              <input type="text" id="nome" placeholder="Wilson Wagner B Pederneiras" required />
            </div>
          </div>
          ...
          <div class="linha">
            ...
            <div id="inputCVV" class="input">
              <input type="text" id="cvv" data-mask="000" placeholder="xxx" required/>
            </div>
          </div>
          ...
          <div class="linha">
            ...
            <div class="seletor parcela">
              <select id="parcela"  >
                <option value="selecioneParcela"  selected disabled >Parcela</option>
