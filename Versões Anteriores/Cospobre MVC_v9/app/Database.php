...
class Database
{
    ...
    static public function createSchema(): void
    {
        ...
        if (!$dt ){
            ...
            VALUES ("Peruca Saber", "R$ 60,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaSaber.svg");
        ...
        if (!$dt ){
            $con->exec('
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Agatsuma Zenitsu", "R$155,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaAgatsumaZenitsu.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
        ...
        if (!$dt ){
            $con->exec('
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Mauiua Tatsuko", "R$115,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaMauiuaTatsusuko.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
        ...
        if (!$dt ){
            $con->exec('
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Asuna Homura", "R$ 90,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaAsunaHomura.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
        ...
        if (!$dt ){
            $con->exec('
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Arashi Henra", "R$ 98,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaArashiHenra.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
        ...
        if (!$dt ){
            $con->exec('
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Haya Konbuka", "R$120,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaHayaKonbuka.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
        ...
        if (!$dt ){
            ...
            INSERT INTO Produto (nome, preco, categoria, tamanho, img) 
            VALUES ("Peruca Chanel Verde", "R$ 35,00", "Perucas", "P", "/Cospobre MVC/public/images/PerucaChanelVerde.svg");
            INSERT OR REPLACE INTO Descricao (produto, material, cor, tt) 
