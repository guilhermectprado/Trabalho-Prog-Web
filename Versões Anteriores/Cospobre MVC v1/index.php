...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="app/view/public/images/cabecaum.ico">
    <link rel="stylesheet" href="app/view/public/style/style.css">
    <script src="app/view/public/script/script.js"></script>
    <script src="app/view/public/script/menu.js"></script>
  </head>

  <body>
    <header>
      <div class="container">
        <img class="logo" src="app/view/public/images/logo.svg" alt="logo" />
    ...
    <img src="app/view/public/images/landing-page.svg" alt="otakus" width="100%" />
    <main>
