...
<html lang="en">
  ...
  <body>
    ...
    <div class="cards">
      <div class="card">
        <img id="cartas" src="public/images/hitaiite.svg" alt="hitai" />
      ...
      <div class="card">
        <img id="cartas" src="public/images/shuriken.svg" alt="shurikem" />
        <div class="card-content">
          <h4>Shuriken</h4>
        </div>
        <div class="card-price">
      ...
      <div class="card">
        <img id="cartas" src="public/images/shingeki.svg" alt="shingeki" />
        <div class="card-content">
      ...
      <div class="card">
        <img id="cartas" src="public/images/baculo.svg" alt="baculo" />
        <div class="card-content">
      ...
      <div class="card">
        <img id="cartas" src="public/images/cartas.svg" alt="cartas" />
        <div class="card-content">
      ...
      <div class="card">
        <img id="cartas" src="public/images/zelda.svg" alt="zelda" />
        <div class="card-content">
          <h4>Armas Zelda</h4>
        </div>
        <div class="card-price">
      ...
      <div class="card">
        <img id="cartas" src="public/images/batman.svg" alt="batman" />
        <div class="card-content">
      ...
      <div class="card">
        <img id="cartas" src="public/images/spiderman.svg" alt="spiderman" />
        <div class="card-content">
