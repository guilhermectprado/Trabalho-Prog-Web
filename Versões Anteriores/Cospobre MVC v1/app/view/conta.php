...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="public/style/conta.css" />
  ...
  <body>
    ...
    <div class="conteudo">
      <div class="linha">
        <img id="imagem" src="public/images/levi.svg" alt="Levi" />
          ...
          <form method="post" action="" name ="logar">
            ...
            <div class="linha">
              ...
              <div class="input" id="senhaicon">
                ...
                <img src="public/images/olhofechado.svg" id ="olho" alt="Mostrar Senha" onclick="mostrarEsconder()">    
              </div>
            </div>
        ...
        <img id="imagem2" src="public/images/mikasa.svg" alt="Mikasa" />
      </div>
    </div>
  </body>
</html>
