<?php 
	session_start();
	require_once "func_produto.php";
	require_once "func_carrinho.php";

	$pdoConnection = require_once "Database.php";
                ...
                <nav>
                    <ul>
                        ...
                        <li>
                            ...
                            <ion-icon name="person-outline" class="conta" href="<?= BASEPATH ?>login"></ion-icon>
